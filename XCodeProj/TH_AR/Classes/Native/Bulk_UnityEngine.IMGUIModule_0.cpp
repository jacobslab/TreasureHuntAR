...
{
	{
		...
		int32_t* L_1 = ___index0;
		bool L_2 = TextEditor_IsValidCodePointIndex_m2710122096(__this, (*((int32_t*)L_1)), /*hidden argument*/NULL);
		if (L_2)
		{
			goto IL_001f;
		}
	}
	{
		...
		int32_t* L_4 = ___index0;
		int32_t L_5 = TextEditor_NextCodePointIndex_m2307157131(__this, (*((int32_t*)L_4)), /*hidden argument*/NULL);
