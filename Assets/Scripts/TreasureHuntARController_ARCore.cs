...
/// </summary>
public class TreasureHuntARController_ARCore: MonoBehaviour
{
	/// <summary>
	...
	//A SINGLETON
	private static TreasureHuntARController_ARCore _instance;

	public static TreasureHuntARController_ARCore Instance {
		get {
			return _instance;
		}
	}
